    ...
    extends TypedXmlWriter, BodyType
{
    ...
    @XmlAttribute
    public org.jboss.com.sun.xml.ws.wsdl.writer.document.soap.Header message(QName value);

    @XmlElement
    public HeaderFault headerFault();

    @XmlAttribute
    public org.jboss.com.sun.xml.ws.wsdl.writer.document.soap.BodyType part(String value);
