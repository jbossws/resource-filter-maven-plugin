...
/**
 * Client-side XML-based message dispatcher {@link org.jboss.com.sun.xml.ws.pept.protocol.MessageDispatcher}
 *
...
//            messageInfo.setEncoder(encoder);
    ...
    protected Map<String, Object> processMetadata(MessageInfo messageInfo, XMLMessage xm) {
        ...
        if (runtimeContext != null) {
            ...
            if (javaMethod != null) {
                String soapAction = ((org.jboss.com.sun.xml.ws.model.soap.SOAPBinding) javaMethod.getBinding()).getSOAPAction();
                header.clear();
                if (soapAction == null) {
