...
public class SOAPMessageDispatcher implements MessageDispatcher {
    ...
    private static final Logger logger = Logger.getLogger(
        org.jboss.com.sun.xml.ws.util.Constants.LoggingDomain + ".server.soapmd");
    ...
    public void receive(MessageInfo messageInfo) {
        ...
        try {
            ...
            try {
                ...
                if (((org.jboss.com.sun.xml.messaging.saaj.soap.MessageImpl) soapMessage).acceptFastInfoset()) {
