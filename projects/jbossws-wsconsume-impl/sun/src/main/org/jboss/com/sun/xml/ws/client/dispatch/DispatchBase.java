...
public class DispatchBase implements BindingProvider, InternalBindingProvider,
    ...
    public void _setTransportFactory(org.jboss.com.sun.xml.ws.spi.runtime.ClientTransportFactory f) {
    ...
    private void setMessageStruct(MessageStruct messageStruct, Object msg) {
        ...
        bindingId.equals(SOAPBinding.SOAP12HTTP_MTOM_BINDING))
           messageStruct.setMetaData("org.jboss.com.sun.xml.ws.mtom.enabled", ((SOAPBindingImpl)getBinding()).isMTOMEnabled());
