 ...
 */
public class RuntimeEndpointInfo implements org.jboss.com.sun.xml.ws.spi.runtime.RuntimeEndpointInfo {
    ...
    private static final Logger logger = Logger.getLogger(
        org.jboss.com.sun.xml.ws.util.Constants.LoggingDomain + ".server.endpoint");
    private static final Localizer localizer = new Localizer();
    private static final LocalizableMessageFactory messageFactory =
        new LocalizableMessageFactory("org.jboss.com.sun.xml.ws.resources.server");
        ...
        if(wsdlUrl == null){
            ...
            try {
                ...
                if(getPortName() != null){
                    ...
                    List<org.jboss.com.sun.xml.ws.wsdl.parser.Binding> bindings = wsdlDoc.getBindings(service, bindingId);
                    if(bindings.size() == 0)
    ...
    /**
     * creates a RuntimeModel using @link org.jboss.com.sun.xml.ws.modeler.RuntimeModeler. 
