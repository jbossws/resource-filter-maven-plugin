 ...
 *    and uses {@link org.jboss.com.sun.tools.ws.processor.modeler.annotation.WebServiceAP 
 ...
 *    processing.  First the {@link org.jboss.com.sun.tools.ws.processor.Processor#runModeler() 
 *    Processor.runModeler()} method is called to create an instance of the 
 *    {@link org.jboss.com.sun.tools.ws.processor.modeler.wsdl.WSDLModeler WSDLModeler} to
 *    process the WSDL being imported, which intern processes the WSDL and creates 
 *    a {@link org.jboss.com.sun.tools.ws.processor.model.Model Model} that is returned to the 
 *    Processor.  The CompileTool then registers a number of 
 *    {@link org.jboss.com.sun.tools.ws.processor.ProcessorAction ProcessorActions} with the 
 ...
 *    The CompileTool then invokes the {@link org.jboss.com.sun.tools.ws.processor.Processor#runActions() 
    ...
    public void buildModel(String endpoint) {
        ...
        if (genWsdl) {
            ...
            org.jboss.com.sun.xml.ws.modeler.RuntimeModeler rtModeler = 
                    new org.jboss.com.sun.xml.ws.modeler.RuntimeModeler(endpointClass, serviceName, bindingID);
            rtModeler.setClassLoader(classLoader);
            if (portName != null)
                rtModeler.setPortName(portName);
            org.jboss.com.sun.xml.ws.model.RuntimeModel rtModel = rtModeler.buildRuntimeModel();
