...
public class RuntimeModeler {
    ...
    public static final Class RPC_LIT_PAYLOAD_CLASS = org.jboss.com.sun.xml.ws.encoding.jaxb.RpcLitPayload.class;
     ...
     * <code>sei</code>.
     */
    public RuntimeModeler(Class sei, QName serviceName, org.jboss.com.sun.xml.ws.wsdl.parser.Binding binding){
        this.portClass = sei;
        this.serviceName = serviceName;
     ...
     * <code>sei</code>.
     */
    public RuntimeModeler(Class portClass, Object implementor, QName serviceName, org.jboss.com.sun.xml.ws.wsdl.parser.Binding binding) {
...
/*        if (clazz == portClass) {
     ...
     */
    protected org.jboss.com.sun.xml.ws.model.soap.SOAPBinding createBinding(javax.jws.soap.SOAPBinding soapBinding) {
    ...
    protected void processMethod(Method method, WebService webService) {
        ...
        if (methodBinding != null) {
            org.jboss.com.sun.xml.ws.model.soap.SOAPBinding mySOAPBinding = createBinding(methodBinding);
            ...
            org.jboss.com.sun.xml.ws.model.soap.SOAPBinding sb = new org.jboss.com.sun.xml.ws.model.soap.SOAPBinding(defaultBinding);
            if (action != null)
    ...
    protected void processDocWrappedMethod(JavaMethod javaMethod, String methodName,
        ...
        if (!isOneway && (returnType != null) && (!returnType.getName().equals("void"))) {
            ...
            if (resultQName.getLocalPart() != null) {
                ...
                Parameter returnParameter = new Parameter(rTypeReference, org.jboss.com.sun.xml.ws.model.Mode.OUT, -1);
                if (isResultHeader) {
        ...
        for (Class clazzType : parameterTypes) {
            ...
            for (Annotation annotation : pannotations[pos]) {
                if (annotation.annotationType() == javax.jws.WebParam.class) {
                    ...
                    paramMode = (mode == javax.jws.WebParam.Mode.IN) ? org.jboss.com.sun.xml.ws.model.Mode.IN :
                        (mode == javax.jws.WebParam.Mode.INOUT) ? org.jboss.com.sun.xml.ws.model.Mode.INOUT :
    ...
    protected void processRpcMethod(JavaMethod javaMethod, String methodName,
        ...
        if (!isOneway && (returnType != null) && (!returnType.getName().equals("void"))) {
            ...
            if(isResultHeader){
                ...
                ParameterBinding rb = getBinding(binding, operationName, resultPartName, false, org.jboss.com.sun.xml.ws.model.Mode.OUT);
...
//                        responseWrapper.addWrapperChild(param);
    ...
    protected void processDocBareMethod(JavaMethod javaMethod, String methodName,
        ...
        for (Class clazzType : parameterTypes) {
            ...
            if(paramMode == org.jboss.com.sun.xml.ws.model.Mode.INOUT){
                ParameterBinding pb = getBinding(binding, operationName, partName, isHeader, org.jboss.com.sun.xml.ws.model.Mode.IN);
                param.setInBinding(pb);
                pb = getBinding(binding, operationName, partName, isHeader, org.jboss.com.sun.xml.ws.model.Mode.OUT);
                param.setOutBinding(pb);
            }else{
                if (isHeader){
                    param.setBinding(ParameterBinding.HEADER);
    ...
    */
    ...
    private ParameterBinding getBinding(org.jboss.com.sun.xml.ws.wsdl.parser.Binding binding, String operation, String part, boolean isHeader, Mode mode){
        if(binding == null){
            if(isHeader)
