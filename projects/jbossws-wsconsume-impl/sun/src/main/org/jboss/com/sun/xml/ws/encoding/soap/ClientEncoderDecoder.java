...
public class ClientEncoderDecoder extends EncoderDecoder implements InternalEncoder {
    ...
    /* (non-Javadoc)
     * @see org.jboss.com.sun.xml.ws.rt.encoding.EncoderDecoderBase#toMessageInfo(java.lang.Object, com.sun.pept.ept.MessageInfo)
     */
...
//                    reason = frt.get(0).getValue();
    ...
    /* (non-Javadoc)
     * @see org.jboss.com.sun.xml.ws.rt.encoding.EncoderDecoderBase#toInternalMessage(com.sun.pept.ept.MessageInfo)
     */
